...
tp_reset_(tp_reset)
{
    ...
    buscfg.sclk_io_num  = (gpio_num_t)scl;
    buscfg.data0_io_num = (gpio_num_t)d0;
    buscfg.data1_io_num = (gpio_num_t)d1;
    buscfg.data2_io_num = (gpio_num_t)d2;
    buscfg.data3_io_num = (gpio_num_t)d3;
...
void DisplayPort::DisplayPort_TouchInit(void) {
    ...
    tp_io_config.dev_addr = ESP_LCD_TOUCH_IO_I2C_CST9217_ADDRESS;
